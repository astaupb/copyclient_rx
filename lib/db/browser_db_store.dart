...
class BrowserDBStore implements DBStore {
  ...
  void openDb() {
    ...
    if (window.localStorage['setting_density'] == null ||
        window.localStorage['setting_density'].isEmpty) {
      window.localStorage['setting_density'] = 'normal';
    }
    if (window.localStorage['setting_camera_disabled'] == null ||
        window.localStorage['setting_camera_disabled'].isEmpty) {
      window.localStorage['setting_camera_disabled'] = 'normal';
    }

    _settings = {
      'theme': getSetting('theme'),
      'camera_disabled': getSetting('camera_disabled'),
